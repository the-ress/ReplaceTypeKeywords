...
{
    internal class ReplaceTypeKeywordsOnBeforeSave : IVsRunningDocTableEvents3
    {
        private readonly DTE _dte;
        private readonly RunningDocumentTable _runningDocumentTable;
        private readonly DocumentFormatter _documentFormatter;

        public ReplaceTypeKeywordsOnBeforeSave(DTE dte, RunningDocumentTable runningDocumentTable, DocumentFormatter documentFormatter)
        {
